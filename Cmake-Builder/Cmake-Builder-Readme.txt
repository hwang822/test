...
Cmake only need C++ compiler to make C++ builder.

export, install only cross platform deploy.

#######################################
Ctest could run test setup at Cmakelists.txt

option(BUILD_TESTING "" ON)  
#will enalbe Run Test menu function in VS2019.
if(BUILD_TESTING)
	enable_testing()
...
#######################################
CDash download and install https://www.cdash.org/

CDash Testing

CDash.org could run online CDash for user test user codes.
