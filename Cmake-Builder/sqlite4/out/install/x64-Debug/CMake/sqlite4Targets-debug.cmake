...
set_target_properties(sqlite4 PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/sqlite4.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/sqlite4.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS sqlite4 )
list(APPEND _IMPORT_CHECK_FILES_FOR_sqlite4 "${_IMPORT_PREFIX}/lib/sqlite4.lib" "${_IMPORT_PREFIX}/bin/sqlite4.dll" )
